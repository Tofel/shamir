...
// var PRIME = new(big.Int).Sub(new(big.Int).Lsh(big.NewInt(1), 1280), big.NewInt(1))
...
// // Remove padding from share
// func unpadShare(paddedShare string) ([]byte, error) {
// 	shareBytes, err := hex.DecodeString(paddedShare)
// 	if err != nil {
// 		return nil, err
// 	}
// 	// Remove leading zero bytes if any
// 	startIndex := 0
// 	for startIndex < len(shareBytes) && shareBytes[startIndex] == 0 {
// 		startIndex++
// 	}
// 	return shareBytes[startIndex:], nil
// }
...
// 		return nil, err
// 	}
// 	coefficients = append([]*big.Int{secretInt}, coefficients...) // Ensure secret is the first coefficient
